...
class CreditCardWidget extends StatelessWidget{
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Row(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text("TOMIN Card",style: TextStyle(color: color,fontWeight: FontWeight.w400,fontSize: 18.0),),
  ...
  Widget _buildCollapsed(BuildContext context)
  {
    ...
    return Row(
      ...
      children: <Widget>[
        Container(
          padding: EdgeInsets.symmetric(vertical: 28.0,horizontal: 60.0),
          decoration: BoxDecoration(
            color: themeColor,
            borderRadius: BorderRadius.circular(12.0),
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text("\$"+card.balance.toString(),style: Theme.of(context).textTheme.headline.copyWith(color: color,fontWeight: FontWeight.bold,fontSize: 28.0),),
              ),
              Text("TOMIN MiPYME",style: TextStyle(color: color,fontWeight: FontWeight.w400,fontSize: 18.0),),
              Padding(
